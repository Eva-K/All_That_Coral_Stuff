...
CCMR_MitchCoords <- CCMR_Mitch%>%
  left_join(CCMR_All, by ="Name")

CCMR_MitchCoords <- CCMR_MitchCoords%>%
  select("Name", "Longitude","Latitude", "Branching":"Ben_Tot")

# write file
 CCMR_MitchCoords <- write.csv(CCMR_MitchCoords, file = "C:/Users/uqekovac/Documents/R/Coding/GBRBenthic2020/CoralTypeMapping/Mitch2021/CCMR2017.csv")
