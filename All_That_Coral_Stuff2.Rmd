...
MKYZone <- write.csv(MKYZone, file = "C:/Users/uqekovac/Documents/R/Coding/GBRBenthic2020/CoralTypeMapping/Mitch2021/MKY_Ppt_waves_summary.csv")
...
# Make unique names 
# Make ID specific
FNGBRps <- FNGBRps %>% dplyr::mutate(Region = as.character("FNGBR_"))

FNGBRps <- FNGBRps %>% dplyr::mutate(id = row_number())

FNGBRps <- FNGBRps %>% unite("Pixel", Region:id, remove = FALSE)
colnames(FNGBRps)
unique(FNGBRps$Pixel)
