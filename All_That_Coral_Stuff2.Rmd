...
# CCMR 
# add coordinates to Legacy
Legacy <- inner_join(percent_covers_Legacy,LegacyCoordinates, by ="Name") ## not CCMR

# bind CCMR and Legacy
CCMRleg <- bind_rows(CCMR_Kalinda_Fleur_BENTHIC_DATA_submit_v2, Legacy) ## not CCMR
...
#### DO NOT DO #####
# Add row with numbers for Juan
CCMR_pixels_ALL <- CCMR_pixels_ALL %>% add_row(uWSLmean=1,	uWSL100=2,	uWSL99=3,	uWSL90=4,	UonrootTmean=5,	UonrootT100=6,	UonrootT99=7,	UonrootT90=8,	ubedmean=9,	ubed100=10,	ubed99=11,	ubed90=12,	Tpmean=13,	Tp100=14,	Tp99=15,	Tp90=16,	Hsmean=17,	Hs100=18,	Hs99=19,	Hs98=20,	Hs97=21,	Hs96=22,	Hs95=23,	Hs90=24,	Hs80=25,	Hs70=26,	Efmean=27,	Ef100=28,	Ef99=29,	Ef90=30,	Edmean=31,	Ed100=32,	Ed99=33,	Ed90=34,	SLOPE=35, .before = 2)

 
 
## DO NOT GO FURTHER IN THIS BLOCK
## GO TO NEXT BLOCK
